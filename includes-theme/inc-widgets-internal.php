...
class WP_Widget_Categories_Custom extends WP_Widget {
	...
	{
		$widget_ops = array( 'classname' => 'widget_categories widget_categories_custom', 'description' => "A list of categories, with slightly tweaked output." );
		parent::__construct( 'categories_custom', 'Categories Custom', $widget_ops );
	}
	...
	function widget( $args, $instance )
	{
		...
		$title = apply_filters( 'widget_title', empty( $instance['title'] ) ? 'Categories Custom' : $instance['title'], $instance, $this->id_base);
	...
	function form( $instance )
	{
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id('title', 'nwrktheme' ); ?>"><?php echo 'Title:'; ?></label>
		...
		<label for="<?php echo $this->get_field_id('count'); ?>"><?php echo 'Show post counts'; ?></label>
		<br />
		<?php
	}
}
...
/*
Plugin: Recent Posts by Category Widget
http://www.rosscornell.com
*/
...
class rpjc_widget_cat_recent_posts extends WP_Widget {
	...
	function form( $instance ) {
		...
		<p>
			<label for="rpjc_widget_cat_recent_posts_title"><?php echo 'Title'; ?>:</label>
		...
		<p>
			<label for="rpjc_widget_cat_recent_posts_category"><?php echo 'Category'; ?>:</label>              
		...
		<p>
			<label for="rpjc_widget_cat_recent_posts_number"><?php echo 'Number of posts to show'; ?>: </label>
		...
		<p>
			...
			<label for="rpjc_widget_cat_recent_posts_show_date"><?php echo 'Display post date?'; ?></label>
		</p>
