<?php
/*
 * View ESPECIFICA de TAXONOMY: >>>> "category-work", para el post TYPE "work"
 * View que requiere recibir un "TERM" o sea la categoria en parametro "applications"
 * Ejemplo: http://localhost/webs-wp/networkian/category-work/applications/
 */
?>
<!doctype html>  
...
<link rel="stylesheet" href="<?php echo get_template_directory_uri() .  '/templates-wp/taxonomy-category-work/view-taxonomy-category-work.css'; ?>" type="text/css" media="all" />
...
<!-- start view js  -->
<script type="text/javascript" src=" <?php echo get_template_directory_uri() .  '/templates-wp/taxonomy-category-work/view-taxonomy-category-work.js'; ?>"></script>
